...
link2_status=$(curl -Is https://ia601506.us.archive.org/4/items/WS2012R2/WS21012R2.ISO | grep HTTP | cut -f2 -d" ")
...
if [ $link1_status = "200" ] ; then 
	...
	sudo wget -P /mediabots https://ia601506.us.archive.org/4/items/WS2012R2/1S2012R2.ISO
else
