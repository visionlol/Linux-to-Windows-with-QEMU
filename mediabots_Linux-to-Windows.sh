...
link1_status=$(curl -Is https://virtualmedia.online.net/windows/17763.737.190906-2324.rs5_release_svc_refresh_SERVER_EVAL_x64FRE_en-us_1.iso | grep HTTP | cut -f2 -d" ")
link2_status=$(curl -Is https://ia601506.us.archive.org/4/items/WS2012R2/1WS2012R2.ISO | grep HTTP | cut -f2 -d" ")
#sudo wget -P /mediabots https://archive.org/download/WS2012R2/WS2012R2.ISO # Windows Server 2012 R2 
if [ $link1_status = "200" ] ; then 
	sudo wget -P /mediabots https://virtualmedia.online.net/windows/17763.737.190906-2324.rs5_release_svc_refresh_SERVER_EVAL_x64FRE_en-us_1.iso
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /mediabots https://ia601506.us.archive.org/4/items/WS2012R2/WS21012R2.ISO
else
